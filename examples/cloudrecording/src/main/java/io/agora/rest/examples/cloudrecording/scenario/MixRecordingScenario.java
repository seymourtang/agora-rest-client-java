...
public class MixRecordingScenario extends BaseScenario {
    ...
    public void runHLS(String token, StartResourceReq.StorageConfig storageConfig) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            try {
                queryMixHLSRecordingResourceRes = this.cloudRecordingService
                        .mixScenario()
        ...
        try {
            updateLayoutResourceRes = this.cloudRecordingService
                    .mixScenario()
    ...
    public void runHLSAndMP4(String token, StartResourceReq.StorageConfig storageConfig) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            try {
                queryMixHLSAndMP4RecordingResourceRes = this.cloudRecordingService
                        .mixScenario()
